...
namespace SGPHOOKAPI.Reports
{
    ...
    {
        public static string RptPhieuGui = "~/Reports/mailer.rpt";
        public static string RptPhieuGuiFPTHCM = "~/Reports/mailer.rpt";
        public static string RptPhieuGuiFPTDNI = "~/Reports/mailer-fpt-kv03.rpt";
        public static string RptPhieuGuiFPTCTO = "~/Reports/mailer-fpt-kv04.rpt";
        public static string RptPhieuGuiPSDCTHO = "~/Reports/mailerpsd.rpt";
    }
}