...
export class DataService {
    ...
    getProvince() {
        return this.httpClient.get(APIURL + 'api/sgphub/GetProvince');
    }

    getDistrict(provinceId) {
        return this.httpClient.get(APIURL + 'api/sgphub/GetDistrict?ProvincePMS=' + provinceId);
    }
    ...
    getSGPOrder(data) {
        ...
        return this.httpClient.get(APIURL + 'api/sgphub/GetOrdeByStatus?mailerid=' + data.mailerid + '&cusid=' + data.cusid + '&dateFrom=' + data.dateFrom + '&dateTo=' + data.dateTo + '&status=' + data.status + '&deliveryStatus=' + data.deliveryStatus, httpOption)
    }
    updateOrder(data) {
        const token = 'bearer ' + getToken();
        const httpOption = {
        ...
        return this.httpClient.post(APIURL + 'api/sgphub/UpdateOrder', data, httpOption)
    }
    ...
    updateFPTOrder(data) {
        ...
        return this.httpClient.post(APIURL + 'api/fpthook/UpdateOrder', data, httpOption)
    }
    ...
    printReports(data) {
        ...
        */
        return APIURL + 'Report/PhieuGuiPSD?dateFrom=' + data.dateFrom + '&dateTo=' + data.dateTo + '&status=' + data.status + '&cusid=' + data.cusid;
    }
...
*/
        return APIURL + 'Report/InMotPhieu?id=' + mailerid;
    }
    printExcels(data) {
        const token = 'bearer ' + getToken();
        const httpOption = {
    ...
    getUserInfos() {
        ...
        return this.httpClient.get(APIURL + 'api/sgphub/GetUserInfo', httpOption);
    }
